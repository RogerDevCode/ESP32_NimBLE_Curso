...
ESTE CÓDIGO DEBE ESTAR LISTO PARA IMPLEMENTACIONES CRÍTICAS donde la fiabilidad es requisito no negociable: dispositivos médicos, control industrial, sistemas de seguridad, aeroespacial, etc.

Que no se te olvide al final, crea un readme.md, usando un estilo literario, pero profesional y formal, que mantenga la atencion en el lector, explicando que hace el proyecto, como utilizarlo, que se espera de la ejecucion, y las posibles situaciones limites. 
